...
checkIconsInDir = require('spritesmith-dir-checker');
merge = require('merge-stream');

cwd = path.join(__dirname, '..');
spritesDirPath = 'frontend/sprites';
imgPath = '../img/sprites/';
...
###PNG sprites###
gulp.task 'png', ->
  spriteData = gulp.src ['frontend/sprites/**/*.png', '!frontend/sprites/*.png']
    .pipe plugins.plumber errorHandler: plugins.notify.onError("Error: <%= error.message %>")
    .pipe spritesmith
      spritesmith: (options) ->
  ...
  imgStream = spriteData.img.pipe(gulp.dest('public_html/assets/img/sprites'))
  styleStream = spriteData.css.pipe(gulp.dest('frontend/styles/sprites'))
